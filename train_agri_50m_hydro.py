"""
AgriTinyGPT Rung 4 - ~51.7M parameters
Hydroponics ONLY (no other domains mixed in) - full A-Z completion: all 6 system
types, all growing media, full nutrient/deficiency list, ~19 crop types (leafy
greens, fruiting vegetables, herbs, vine crops, root vegetables), 3 flowers
(marigolds, petunias, orchids), light/CO2/water treatment/pests, and system-to-crop
matching guidance. Starting with this rung, each future rung covers one domain only.
"""
...
with open("agri_corpus_50m_hydro.txt", "r", encoding="utf-8") as f:
    text = f.read()
