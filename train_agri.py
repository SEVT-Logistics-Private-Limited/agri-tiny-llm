import torch, torch.nn as nn, re, math
...
# ---------------- Load corpus ----------------
with open("agri_corpus.txt", "r", encoding="utf-8") as f:
    text = f.read()

# ---------------- Simple word-level tokenizer ----------------
# Split on words / punctuation, keep it simple and dependency-free.
def tokenize(s):
...
# ---------------- Config: tuned to land near 1M params given vocab_size ----------------
block_size = 64
n_embd     = 160
n_head     = 8
n_layer    = 3
